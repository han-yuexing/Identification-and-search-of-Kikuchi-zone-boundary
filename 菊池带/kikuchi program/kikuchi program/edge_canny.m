...
% 功能：对于图片中的边缘使用Canny算子进行检测
% 作者：Yongli Yan. 2017-8-1.
% 改写：无
% 输入: I: 原始图片
%       gaussDim: 高斯滤波模板窗口的大小
%       sigma: Canny算子sigma
%       percentOfPixelsNotEdges: 图像中非特征的数量比例
%       thresholdRatio: Canny算子高低阈值比
% 输出: 无
% Return: imgCanny: 检测得到的边缘图像
